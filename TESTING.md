...
|  As a user I can create a new account so that I can access all the features for signed up users | Y   |  |
| As a user I can sign in to the app so that I can access functionality for logged in users | Y   |  |
| As a user I can tell if I am logged in or not. | Y   |  |
| As a logged out user I can see signing in/up options allowing me to sign in/out | Y   |  |
| As a logged in user I can create posts so that I can share my posts | Y   |  |
| As a logged in user I can create posts so that I can share my posts | Y   | |
| As a logged in user I can like a post so that show interest in the post | Y   |  |
| As a user I can view all the most recent posts, ordered by most recently created first so that I am up to date with the newest content | Y   | |
| As a user, I can search for posts with keywords, so that I can find the posts, profiles and events that are of interest| Y   | |
| As a logged in user I can view the posts I liked so that I can find the posts I enjoy the most | Y   |  |
...
| As a user I can view the posts page so that I can read the comments about the post | Y   |  |
| As a post owner I can edit my post title and description so that I can make corrections or update my post after it was created | Y   |  |
| As a logged in user I can add comments to a post so that I can share my thoughts about the post | Y   |  |
| As a user I can see how long ago a comment was made so that I know how old a comment is | Y   |  |
| As a user I can read comments on posts so that I can read what other users feedback about the posts | Y   |  |
| As the creator of the comment i can delete my comment so that i can remove my own comment | Y   |  |
| As the creator of a comment i can edit my comments so that i can fix any errors on the existing comment | Y   |  |
| As a user I can view other users profiles so that I can see their posts and learn more about them | Y   |  |
| As a logged in user I can edit my profile so that I can change any infomation required on my profile | Y   |  |
| As a logged in user I can update my username and password so that I can change my display name and keep my profile secure | Y   |  |
| As a user, i want to be able to see the most popular profiles so i can see which profiles are popular. | Y   |  |
| As a user i want to be able to follow and unfollow other users so i can either see or remove their content from my feed. | Y   |  |
| As a use, i want to be able to see the events page so that i can look through any events that may interest me. | Y   |  |
